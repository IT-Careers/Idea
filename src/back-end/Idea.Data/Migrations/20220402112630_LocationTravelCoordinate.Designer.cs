...
namespace Idea.Data.Migrations
{
    ...
    [Migration("20220402112630_LocationTravelCoordinate")]
    partial class LocationTravelCoordinate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Idea.Data.Models.Locations.Location", b =>
                {
                    ...
                    b.Property<string>("TravelCoordinateId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Idea.Data.Models.Shared.Coordinate", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Idea.Data.Models.Shared.Position", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BackLowerLeftId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BackLowerRightId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BackUpperLeftId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BackUpperRightId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("FrontLowerLeftId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("FrontLowerRightId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("FrontUpperLeftId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("FrontUpperRightId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("BackLowerLeftId");

                    b.HasIndex("BackLowerRightId");

                    b.HasIndex("BackUpperLeftId");

                    b.HasIndex("BackUpperRightId");

                    b.HasIndex("FrontLowerLeftId");

                    b.HasIndex("FrontLowerRightId");

                    b.HasIndex("FrontUpperLeftId");

                    b.HasIndex("FrontUpperRightId");
            ...
            modelBuilder.Entity("Idea.Data.Models.CelestialObjects.Planetary", b =>
                {
                    ...
                    b.HasOne("Idea.Data.Models.Shared.Position", "Position")
                        .WithMany()
            ...
            modelBuilder.Entity("Idea.Data.Models.Locations.Location", b =>
                {
                    ...
                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "TravelCoordinate")
                        .WithMany()
                        .HasForeignKey("TravelCoordinateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Idea.Data.Models.Shared.Position", b =>
                {
                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "BackLowerLeft")
                        .WithMany()
                        .HasForeignKey("BackLowerLeftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "BackLowerRight")
                        .WithMany()
                        .HasForeignKey("BackLowerRightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "BackUpperLeft")
                        .WithMany()
                        .HasForeignKey("BackUpperLeftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "BackUpperRight")
                        .WithMany()
                        .HasForeignKey("BackUpperRightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "FrontLowerLeft")
                        .WithMany()
                        .HasForeignKey("FrontLowerLeftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "FrontLowerRight")
                        .WithMany()
                        .HasForeignKey("FrontLowerRightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "FrontUpperLeft")
                        .WithMany()
                        .HasForeignKey("FrontUpperLeftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Idea.Data.Models.Shared.Coordinate", "FrontUpperRight")
                        .WithMany()
                        .HasForeignKey("FrontUpperRightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BackLowerLeft");

                    b.Navigation("BackLowerRight");

                    b.Navigation("BackUpperLeft");

                    b.Navigation("BackUpperRight");

                    b.Navigation("FrontLowerLeft");

                    b.Navigation("FrontLowerRight");

                    b.Navigation("FrontUpperLeft");

                    b.Navigation("FrontUpperRight");
                });
